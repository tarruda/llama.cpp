...
ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv41_attn_scores_simd(ggml_metal_library_t lib) {
    const char * name = "kernel_dsv41_attn_scores_simd";
    auto res = ggml_metal_library_get_pipeline(lib, name);
    if (!res.pipeline) { res = ggml_metal_library_compile_pipeline(lib, name, name, nullptr); }
    return res;
}

ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv41_attn_unpack_rows(ggml_metal_library_t lib) {
    const char * name = "kernel_dsv41_attn_unpack_rows";
    auto res = ggml_metal_library_get_pipeline(lib, name);
    if (!res.pipeline) { res = ggml_metal_library_compile_pipeline(lib, name, name, nullptr); }
    return res;
}
...
ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv41_moe_combine(ggml_metal_library_t lib) {
    const char * name = "kernel_dsv41_moe_combine_f32";
...
ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_moe_combine(ggml_metal_library_t lib) {
    const char * name = "kernel_moe_combine_f32";
...
ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_moe_weights(ggml_metal_library_t lib) {
    const char * name = "kernel_moe_weights_f32";
...
ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_qwen4exp_hc_reduce(ggml_metal_library_t lib) {
    const char * name = "kernel_qwen4exp_hc_reduce_f32";
...
ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_qwen4exp_hc_combine(ggml_metal_library_t lib) {
    const char * name = "kernel_qwen4exp_hc_combine_f32";
...
ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mm_id(ggml_metal_library_t lib, const ggml_tensor * op, bool compact, bool tail16) {
    ...
    if (!res.pipeline) {
        ...
        ggml_metal_cv_set_bool(cv, bc_inp, FC_MUL_MM + 0);
        ggml_metal_cv_set_bool(cv, compact, FC_MUL_MM + 6);
