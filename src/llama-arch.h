...
enum llm_kv {
    ...
    LLM_KV_PER_LAYER_EMBEDDING_LAYERS,
    LLM_KV_PER_LAYER_EMBEDDING_NGRAM_SIZE,
    LLM_KV_PER_LAYER_EMBEDDING_HEADS_PER_NGRAM,
    LLM_KV_PER_LAYER_EMBEDDING_VOCAB_SIZE_DIVISOR,
    LLM_KV_PER_LAYER_EMBEDDING_CONV_KERNEL,
    LLM_KV_PER_LAYER_EMBEDDING_EOS_TOKEN_ID,
    LLM_KV_PER_LAYER_EMBEDDING_LAYER_MULTIPLIERS,
    LLM_KV_PER_LAYER_EMBEDDING_HEAD_OFFSETS,
    LLM_KV_PER_LAYER_EMBEDDING_HEAD_VOCAB_SIZES,
...
enum llm_tensor {
    ...
    LLM_TENSOR_NEXTN_EMBED_PROJ,
    LLM_TENSOR_NEXTN_HIDDEN_PROJ,
