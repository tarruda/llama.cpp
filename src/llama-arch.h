...
enum llm_kv {
    ...
    LLM_KV_DENSE_ACTIVATION_DTYPE,
    LLM_KV_EXPERT_ACTIVATION_DTYPE,
    ...
    LLM_KV_ATTENTION_KV_SOURCE_LAYERS,
    LLM_KV_ATTENTION_INDEX_SOURCE_LAYERS,
    LLM_KV_ATTENTION_INDEXER_CANDIDATE_SOURCE_LAYER,
    LLM_KV_ATTENTION_INDEXER_CANDIDATE_TOPK_BLOCKS,
    LLM_KV_ATTENTION_INDEXER_CANDIDATE_BLOCK_SIZE,
    ...
    LLM_KV_ENGRAM_LAYERS,
    LLM_KV_ENGRAM_NGRAM_SIZE,
    LLM_KV_ENGRAM_HEAD_COUNT,
    LLM_KV_ENGRAM_HEAD_DIM,
    LLM_KV_ENGRAM_EMBEDDING_COUNTS,
    LLM_KV_ENGRAM_COMPRESSED_VOCAB_SIZE,
    LLM_KV_ENGRAM_PAD_TOKEN_ID,
    LLM_KV_ENGRAM_HEAD_BUCKET_SIZES,
    LLM_KV_ENGRAM_HEAD_OFFSETS,
...
enum llm_tensor {
    ...
    LLM_TENSOR_ENGRAM_EMBD_SCALE,
    LLM_TENSOR_ENGRAM_KV,
    LLM_TENSOR_ENGRAM_K_WEIGHT,
    LLM_TENSOR_ENGRAM_Q_WEIGHT,
