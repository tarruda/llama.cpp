...
// V4.1 captures the final attention window; other models capture the full batch.
LLAMA_API uint32_t llama_get_embeddings_layer_inp_n_tokens(struct llama_context * ctx, uint32_t lid);
